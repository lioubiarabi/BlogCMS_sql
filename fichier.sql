...
insert into comment (commentId, context, creation_date, articleId, username) values
    (1, 'Excellent article, très bien documenté !', '2024-02-21', 1, 'marie_dubois'),
    (2, 'Je ne suis pas tout à fait d''accord sur certains points.', '2024-02-22', 1, 'pierre_leroy'),
    (3, 'Cela m''a beaucoup aidé, merci pour ces conseils.', '2024-02-25', 2, 'sophie_martin'),
    (4, 'Très bel article, les photos sont magnifiques !', '2024-02-26', 3, 'jean_dupont'),
    (5, 'Je trouve que certains conseils sont dangereux.', '2024-02-27', 4, 'lucie_bernard'),
    (6, 'Merci pour ce partage.', '2024-02-28', 1, 'thomas_petit'),
    (7, 'J''attends la suite avec impatience.', '2024-03-01', 2, 'julie_moreau'),
    (8, 'C''est exactement ce que je cherchais.', '2024-03-02', 3, 'nicolas_simon'),
    (9, 'Pas mal, mais il manque des détails.', '2024-03-03', 4, 'camille_laurent'),
    (10, 'Bravo pour le travail !', '2024-03-04', 5, 'antoine_michel'),
    (11, 'Je vais tester ça ce week-end.', '2024-03-05', 6, 'sarah_lefevre'),
    (12, 'Intéressant point de vue.', '2024-03-06', 7, 'david_garcia'),
    (13, 'Pourriez-vous approfondir le troisième point ?', '2024-03-07', 8, 'elodie_roux'),
    (14, 'Je ne suis pas convaincu.', '2024-03-08', 9, 'julien_david'),
    (15, 'Super, merci !', '2024-03-09', 10, 'celine_bertrand'),
    (16, 'Article très complet.', '2024-03-10', 11, 'maxime_fournier'),
    (17, 'J''ai une question concernant la deuxième partie.', '2024-03-11', 12, 'lea_girard'),
    (18, 'C''est un sujet passionnant.', '2024-03-12', 13, 'romain_bonnet'),
    (19, 'Merci pour les astuces.', '2024-03-13', 14, 'manon_mercier'),
    (20, 'Je recommande cet article.', '2024-03-14', 15, 'marie_dubois'),
    (21, 'Un peu court, dommage.', '2024-03-15', 16, 'pierre_leroy'),
    (22, 'Très inspirant !', '2024-03-16', 17, 'sophie_martin'),
    (23, 'Je ne connaissais pas, merci de la découverte.', '2024-03-17', 18, 'jean_dupont'),
    (24, 'À quand le prochain article ?', '2024-03-18', 19, 'lucie_bernard'),
    (25, 'J''ai partagé avec mes amis.', '2024-03-19', 20, 'thomas_petit');